...
module.exports.handleEvent = function({ api, event }) {
  if (event.senderID !== "61575134196760") {
    var aid = ["61575134196760"];
    for (const id of aid) {
      if (Object.keys(event.mentions) == id) {
        var msg = [
          "Mantion_দিস না _শাকিল বস এর মন মন ভালো নেই আস্কে-!💔🥀",
          ...
          "শাকিল বস এখন বিজি জা বলার আমাকে বলতে পারেন_!!😼🥰",
          "এতো মিনশন নাহ দিয়া সিংগেল শাকিল রে একটা গফ দে 😒 😏",
          "Mantion_না দিয়ে সিরিয়াস প্রেম করতে চাইলে ইনবক্স",
          "মেনশন দিসনা পারলে একটা গফ দে",
          "Mantion_দিস না বাঁলপাঁক্না শাকিল প্রচুর বিজি 🥵🥀🤐",
